function params = fit_extended_tofts_conv(timesSampled,CtSampled)
%
...
%           that uses conv as an estimator for the convolution integral.
%  
%  INPUTS: 
...
tofts = @calc_extended_tofts_conv; 
