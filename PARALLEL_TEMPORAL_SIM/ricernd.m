...
%   inputs.
%
%  -> Note, to add Rician noise to data, let v represent the data. The
%  parameter s then represents the "scale" of the noise (i.e. distance from
%  origin of Rice distribution in 2D plane).
%
