function [ paramMap ] = Get_Linear_Parameters( reconImages, sliceNumber,...
    effTimes, mask )
...
%
%  OUTPUTS: 
%    paramMap        -> A map of parameters describing the linear
%                       model S(t) = (t./t(end)) * A + B. 
